...
namespace RETS
{
    public class sredni
    {
        public const string fileName = "czassredni.txt";
        public static void HandleSredni(List<TimeSpan> everyDayResult)
        {

            Console.WriteLine("Wybrano 2 - średniego");
            int ktorydzien = 1;
            ...
            while (true)
            {
                ...
                if (input == "s" || input == "S")
                {
                    ...
                    WorkTimeActions.PerformActionsBasedOnWorkedHourssredni(totalWorkedTime.TotalHours, totalWorkHours.TotalHours);
