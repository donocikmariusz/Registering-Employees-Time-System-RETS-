...
namespace RETS
{
    public class zwykly
    {
        ...
        public static void HandleZwykly(List <TimeSpan> everyDayResult)
        {

            Console.WriteLine("Wybrano 1 - zwykłego produkcyjnego");
            int ktorydzien = 1;
            ...
            while (true)
            {
                ...
                if (input == "s" || input == "S")
                {
                    ...
                    WorkTimeActions.PerformActionsBasedOnWorkedHourszwykły(totalWorkedTime.TotalHours, totalWorkHours.TotalHours);
